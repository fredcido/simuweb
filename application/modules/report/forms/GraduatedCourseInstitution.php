 ...
 */
class Report_Form_GraduatedCourseInstitution extends Report_Form_StandardSearch
{
    /**
     * 
     */
	...
	$elements[] = $this->createElement( 'hidden', 'path' )
			    ->setValue( 'student-class/course-institution-report' )
			    ->setAttrib( 'class', 'no-clear' )
			    ->setDecorators( array( 'ViewHelper' ) );
	
	$elements[] = $this->createElement( 'hidden', 'title' )
			    ->setValue( 'Relatoriu: Graduadu liu husi Kursu/Inst. Ensinu' )
			    ->setAttrib( 'class', 'no-clear' )
			    ->setDecorators( array( 'ViewHelper' ) );
