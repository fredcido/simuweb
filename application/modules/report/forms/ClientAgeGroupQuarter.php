 ...
 */
class Report_Form_ClientAgeGroupQuarter extends Report_Form_StandardSearch
{
    /**
     * 
     */
	...
	$elements[] = $this->createElement( 'hidden', 'path' )
			    ...
			    ->setValue( 'client/age-group-quarter-report' )
			    ->setDecorators( array( 'ViewHelper' ) );
	
	$elements[] = $this->createElement( 'hidden', 'title' )
			    ->setAttrib( 'class', 'no-clear' )
			    ->setValue( 'Relatoriu: Grupu Idade / Quarter' )
			    ->setDecorators( array( 'ViewHelper' ) );
