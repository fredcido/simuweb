 ...
 */
class Report_Form_GraduatedDistrict extends Report_Form_StandardSearch
{
    /**
     * 
     */
	...
	$elements[] = $this->createElement( 'hidden', 'path' )
			    ->setValue( 'student-class/district-report' )
			    ->setAttrib( 'class', 'no-clear' )
			    ->setDecorators( array( 'ViewHelper' ) );
	
	$elements[] = $this->createElement( 'hidden', 'title' )
			    ->setValue( 'Relatoriu: Graduadu liu husi Distritu' )
			    ->setAttrib( 'class', 'no-clear' )
			    ->setDecorators( array( 'ViewHelper' ) );
