...
class Report_Form_AudiensiaAkonsellamentuTuirKonselleiru extends Report_Form_StandardSearch
{
    /**
     * @var string
     */
    const PATH = 'client/audiensia-akonsellamentu-tuir-konselleiru-report';
    
    /**
     * @var string
     */
    const TITLE = 'Relatoriu: Audiensia Akonsellamentu Tuir Konselleiru';
