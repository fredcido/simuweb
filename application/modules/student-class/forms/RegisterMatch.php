 ...
 */
class StudentClass_Form_RegisterMatch extends StudentClass_Form_RegisterCandidate
{
    /**
     * 
     */
	...
	$elements[] = $this->createElement( 'hidden', 'fk_id_fefpstudentclass' )->setDecorators( array( 'ViewHelper' ) )->setAttrib( 'class', 'no-clear' );
