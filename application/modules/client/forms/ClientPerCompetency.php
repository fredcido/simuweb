 ...
 */
class Client_Form_ClientPerCompetency extends Client_Form_ClientCompetency
{
    public function init()
    {
      ...
      $elements[] = $this->createElement( 'hidden', 'id_percompetency' )
