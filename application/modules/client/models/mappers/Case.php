...
class Client_Model_Mapper_Case extends App_Model_Abstract
{
    ...
    const RESPONSIBLE_CLIENT = 'C';
    const RESPONSIBLE_COUNSELLOR = 'S';
     ...
     * @return int
     */
    public function saveCase($addMessage = true)
    {
        ...
        // Save the Client
        $id = parent::_simpleSave(null, $addMessage);
    ...
    public function saveBarriers()
    {
        ...
        foreach ($this->_data['fk_id_barrier_type'] as $pos => $type) {
            ...
            $row->responsible = $this->_data['responsible'][$pos];
