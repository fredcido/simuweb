...
Client.Case = {
   ...
   configDevelopment: function()
   {
	...
	{	  
		...
		function()
		{
		    dataForm.push( {name: 'status['+ $( this ).attr( 'id' ) + ']', value: $( this ).val()} );
		}
	    );
		...
		function()
		{
		    dataForm.push( {name: 'date_finish['+ $( this ).data( 'id' ) + ']', value: $( this ).val()} );
		}
	    );
   ...
   editNote: function( id )
   {
	$.ajax(
		...
		success: function ( response )
		{
		    $( '#register-note form' ).populate( response, {resetForm: true} );
   ...
   editAppointment: function( id )
   {
	$.ajax(
		...
		success: function ( response )
		{
		    $( '#register-appointment form' ).populate( response, {resetForm: true} );
